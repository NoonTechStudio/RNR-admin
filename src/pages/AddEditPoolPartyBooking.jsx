...
const AdminEditPoolPartyBookingPage = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    const foodPackagePrice = (formData.withFood && selectedFoodPkg)
      ? (selectedFoodPkg.pricePerAdult * formData.adults) + (selectedFoodPkg.pricePerKid * formData.kids)
      : 0;
              ...
              <section className="border border-gray-200 rounded-xl p-5">
                ...
                {activeOffer ? (
                  <p className="text-sm text-gray-500">
                    A special offer is active for this date — coupons cannot be combined.
                  </p>
                ) : appliedCoupon ? (
